...
#include <pthread.h>
#include "ffmpeg-hack.h"

static void *mainThreadFunc(void *argv0) {
    const char *args[] = {(char *) argv0, "-i", "tcp://localhost:6969", "/tmp/%05d.jpg", NULL};
    main2(sizeof(args) / sizeof(args[0]) - 1, (char **) args);
    return NULL;
}
